...
output "output_v2_1" {
  ...
  value = toset([for t in data.aws_ec2_instance_type_offerings.my_ins_type2: t.instance_types]) # ["t3.micro"], ["t3.micro"], []
}
...
output "output_v2_2" {
  value = {
    for az, details in data.aws_ec2_instance_type_offerings.my_ins_type2: az => details.instance_types # {us-east-1: "t3.micro", us-east-1b: "t3.micro", us-east-1e: ""}
  }
}
